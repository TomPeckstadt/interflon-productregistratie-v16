...
export default function Login() {
  ...
  // Check NFC support only after component mounts (client-side)
  useEffect(() => {
    setMounted(true)
  ...
  // Don't render NFC section until component is mounted (prevents SSR issues)
  if (!mounted) {
    return (
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          {/* NFC Badge Login Section - Only render client-side */}
